...
const Sidebar = memo(function Sidebar({ expanded, onExpand, onNavClick, onCollapse }) {
    ...
    const iconMap = {
        ...
        'Add Lectures': BookMarked,
        'Add Subject': BookMarked,
        'Create Timetable': CalendarDays,
        'User Management': Users,
        'Manage Student': Users,
        'Student Admission': ClipboardList,
        'Admission Requests': ClipboardList,
        'Transfer / TC': FileText,
        'Staff Attendance': CheckSquare,
        'Add Teachers': UserPlus,
        'Manage Staff': Users,
        'Tasks': CheckSquare,
                ...
                {expanded ? (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0 text-left">
                            <p className="text-[13px] font-semibold truncate" style={{ color: C.text }}>Admin</p>
