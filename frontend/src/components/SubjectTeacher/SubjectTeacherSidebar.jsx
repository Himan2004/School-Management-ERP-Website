...
import { teacherLogout } from '../../features/auth/teacherAuthSlice.js';
...
// ── Main Sidebar ──
const SubjectTeacherSidebar = memo(function SubjectTeacherSidebar({ expanded, onExpand, onNavClick, onCollapse }) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: FileText,
      children: [
        { label: "Online Test Creation", path: "/subject-teacher/examinations/create-test", icon: Plus },
        { label: "Marks Entry", path: "/subject-teacher/examinations/marks-entry", icon: Edit2 },
    ...
    },
    {
      ...
      icon: Users,
      children: [
        { label: "Class Student Data", path: "/subject-teacher/students/class-data", icon: Users },
    ...
    },
    {
      ...
      icon: AlertTriangle,
      children: [
        // { label: "Raise Complaint", path: "/subject-teacher/complaints/raise", icon: Plus },
    ...
    { label: "Profile", path: "/subject-teacher/profile", icon: User },
  ];
        ...
        {expanded ? (
          ...
          >
            ...
            <div className="flex-1 min-w-0 text-left">
              <p className="text-[13px] font-semibold truncate" style={{ color: C.text }}>Subject Teacher</p>
