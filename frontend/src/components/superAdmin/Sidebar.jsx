...
import { logoutSuperAdmin } from "../../features/auth/superAuthSlice.js";
...
const Sidebar = memo(function Sidebar({
  ...
  const handleLogoutConfirm = useCallback(async () => {
    ...
    try {
      await dispatch(logoutSuperAdmin()).unwrap();
    } catch (_) {
      /* intentional */
    }
  ...
  const menuItems = [
    ...
    { label: "All Schools", path: "/superadmin/all-school", icon: School },
    {
      label: "Academic",
      icon: GraduationCap,
      children: [
        {
          label: "Classes",
          path: "/superadmin/academic/classes",
          icon: Layers,
        },
        {
          label: "Subjects",
          path: "/superadmin/academic/subjects",
          icon: Book,
        },
        {
          label: "Academic Config",
          path: "/superadmin/academic/config",
          icon: Settings,
        },
        {
          label: "Examination",
          path: "/superadmin/academic/examination",
          icon: ClipboardList,
        },
      ],
    },
      ...
      children: [
        {
          ...
          path: "/superadmin/finance/fees",
          icon: Receipt,
        },
        {
          label: "Fee Waivers",
          path: "/superadmin/finance/waivers",
          icon: HandCoins,
        },
        {
          label: "Pending Dues",
          path: "/superadmin/finance/dues",
          icon: PiggyBank,
        },
        {
          label: "Financial Analytics",
          path: "/superadmin/finance/analytics",
    ...
    },
    {
      ...
      icon: Users,
      children: [
        { label: "All Staff", path: "/superadmin/staff/all", icon: UserCog },
        {
          label: "Staff Transfers",
          path: "/superadmin/staff/transfers",
          icon: ArrowLeftRight,
        },
      ],
    },
      ...
      children: [
        {
          ...
          path: "/superadmin/hrm/payroll",
          icon: Wallet,
        },
        {
          label: "Resignations",
          path: "/superadmin/hrm/resignations",
          icon: UserMinus,
        },
        {
          label: "Audit Logs",
        ...
        },
        {
          ...
          path: "/superadmin/hrm/attendance",
          icon: CalendarDays,
        },
      ],
    },
    {
      ...
      children: [
        {
          label: "Comparisons",
          path: "/superadmin/analytics/branch",
          icon: GitBranch,
        },
        {
          label: "Staff Benchmarking",
          path: "/superadmin/hrm/benchmarking",
          icon: UserCheck,
        },
        {
          label: "Performance Trends",
          path: "/superadmin/analytics/trends",
          icon: TrendingUp,
        },
        {
          label: "Admission Trends",
          path: "/superadmin/analytics/admissions",
          icon: UserPlus,
        },
      ],
    },
      ...
      children: [
        {
          ...
          path: "/superadmin/reports/academic",
          icon: BookOpen,
        },
        {
          label: "Staff Reports",
    ...
    },
    {
      ...
      icon: Radio,
      path: "/superadmin/communication/broadcast",
    },

    // ✅ Added Escalations here
    {
      label: "Support Desk",
      path: "/superadmin/support-desk",
      icon: LampDesk,
    },

    { label: "Support", path: "/superadmin/support", icon: LifeBuoy },
    { label: "Policy", path: "/superadmin/policies/discipline", icon: Gavel },
      ...
      const content = (
        <div key={item.label}>
          <button
            ...
            onMouseLeave={(e) => {
              if (!secActive) e.currentTarget.style.background = "transparent";
            }}
          >
            <div
